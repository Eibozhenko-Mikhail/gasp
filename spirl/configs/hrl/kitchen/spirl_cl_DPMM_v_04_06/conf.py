...
########################### Experiment version #########################
#
#   This version was created on 03.06
#
#   Differencies:
#   - DPMM
#   - Correct evaluation
#   - Prior model Checkpoint - "skill_prior_learning/kitchen/spirl_DPMM_h_cl_correct_eval"
#   - Second try of spirl_cl_DPMM_cor_eval
...
ll_policy_params = AttrDict(
    ...
    policy_model_checkpoint=os.path.join(os.environ["EXP_DIR"],
                                         "skill_prior_learning/kitchen/spirl_DPMM_h_cl_v_04_06"),
)
