...
from gasp.modules.layers import BaseProcessingNet, FCBlock
from gasp.modules.losses import L2Loss
from gasp.modules.variational_inference import stack
from gasp.utils.general_utils import AttrDict, batchwise_assign, map_dict, \
    concat_inputs, listdict2dictlist, subdict
from gasp.utils.general_utils import broadcast_final
...
class MLPLSTMCellInitializer(LSTMCellInitializer):
    ...
    def __init__(self, hp, cell, input_sz):
        ...
        from gasp.modules.subnetworks import Predictor    # to avoid cyclic import
