...
from gasp.data.block_stacking.src.robosuite.wrappers import Wrapper
...
class IKWrapper(Wrapper):
    ...
    def __init__(self, env, action_repeat=1):
        ...
        if self.env.mujoco_robot.name == "sawyer":
            from gasp.data.block_stacking.src.robosuite import SawyerIKController
            ...
            from gasp.data.block_stacking.src.robosuite import BaxterIKController
