import numpy as np
from gasp.data.block_stacking.src.robosuite.models.arenas import Arena
from gasp.data.block_stacking.src.robosuite.utils.mjcf_utils import xml_path_completion
