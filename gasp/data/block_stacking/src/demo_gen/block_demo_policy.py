...
from gasp.utils.general_utils import AttrDict, split_along_axis
from gasp.data.block_stacking.src.utils.utils import quat2euler
from gasp.data.block_stacking.src.block_stacking_env import BlockStackEnv
...
if __name__ == "__main__":
    from gasp.data.block_stacking.src.block_task_generator import SingleTowerBlockTaskGenerator
    obs = AttrDict(
